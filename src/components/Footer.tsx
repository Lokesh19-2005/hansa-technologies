    ...
    <footer style={{ background: "#1a1a2e", color: "#e2e8f0", padding: "80px 20px 40px" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2.5fr repeat(3, 1fr)", gap: "40px", marginBottom: "56px" }} className="footer-grid">
          <div>
            <div style={{ background: "#ffffff", borderRadius: "10px", padding: "6px 10px", display: "inline-flex", alignItems: "center", justifyContent: "center", marginBottom: "16px", width: "fit-content" }}>
              <img src="/logo.png" alt="Hansa Technologies" style={{ height: "44px", width: "auto", objectFit: "contain", display: "block" }} />
            </div>
